...
-- depends_on: {{ source('sage200_etl_pte', '_airbyte_raw_purchase_posted_transactions') }}
select
...
from {{ source('sage200_etl_pte', '_airbyte_raw_purchase_posted_transactions') }} as table_alias
